...
% Position
es_xt = subs(scaled_x, {t a0 a1 a2 a3 k}, {ntime 0 0 6 -4 eval_kx});
o_xt = subs(x, {t a0 a1 a2 a3}, {otime 0 0 6 -4});
...
% Velocity
es_dxt = subs(scaled_dx, {t a0 a1 a2 a3 k}, {ntime 0 0 6 -4 eval_kdx});
o_dxt = subs(dx, {t a0 a1 a2 a3}, {otime 0 0 6 -4});
